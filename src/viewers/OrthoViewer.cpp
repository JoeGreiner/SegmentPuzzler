...
std::vector<ShortcutHintPresentation> currentShortcutHintPresentation(const AnnotationSliceViewer *viewer,
    ...
    std::vector<ShortcutHintPresentation> hints{
        ...
        createShortcutHint("images", "Space", "Images",
                           "Hold Space to temporarily show only loaded source images and hide slice indicators.",
                           (viewer != nullptr && viewer->isImageOnlyMode()) || isFlashed("images")),
        createShortcutHint("annotations", "A", "Annotations",
                           "Hold A to temporarily hide loaded source images and slice indicators while keeping annotations and overlays.",
        ...
        createShortcutHint("f10", "F10", "Go To ID",
                           ...
                           isFlashed("f10")),
        createShortcutHint("f7", "F7", "CC Split",
                           "Press F7 to split disconnected components using the selected target and connectivity.",
                           isFlashed("f7")),
