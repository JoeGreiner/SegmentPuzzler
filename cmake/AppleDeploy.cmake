message(STATUS "Creating MACOSX_BUNDLE")
...
#install(FILES "sampleData/Stack.nrrd" DESTINATION "SegmentPuzzler.app/Contents/Resources/sampleData")
...
install(CODE "
  execute_process(
    COMMAND codesign --force --deep --sign - \"${APPS}\"
